...
urlpatterns = patterns('',
		...
		url(r'^nasabah_delete/$', nasabah.delete, name='nasabah_delete'),
		...
		url(r'^utang_nasabah_kolektif/$', report.utang_nasabah_kolektif, name='utang_nasabah_kolektif'),
		url(r'^utang_nasabah_individu/$', report.utang_nasabah_individu, name='utang_nasabah_individu'),
		url(r'^tonase_nasabah_kolektif/$', report.tonase_nasabah_kolektif, name='tonase_nasabah_kolektif'),
		url(r'^tonase_nasabah_individu/$', report.tonase_nasabah_individu, name='tonase_nasabah_individu'),
	)
