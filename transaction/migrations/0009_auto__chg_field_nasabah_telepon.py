...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Nasabah.telepon'
        db.alter_column(u'transaction_nasabah', 'telepon', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Nasabah.telepon'
        db.alter_column(u'transaction_nasabah', 'telepon', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
