...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pembelian.penarikan'
        db.add_column(u'transaction_pembelian', 'penarikan',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['transaction.Penarikan'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pembelian.penarikan'
        db.delete_column(u'transaction_pembelian', 'penarikan_id')
