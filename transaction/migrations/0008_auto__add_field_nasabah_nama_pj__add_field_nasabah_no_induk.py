...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Nasabah.nama_pj'
        db.add_column(u'transaction_nasabah', 'nama_pj',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Nasabah.no_induk'
        db.add_column(u'transaction_nasabah', 'no_induk',
                      self.gf('django.db.models.fields.CharField')(max_length=50, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Nasabah.nama_pj'
        db.delete_column(u'transaction_nasabah', 'nama_pj')

        # Deleting field 'Nasabah.no_induk'
        db.delete_column(u'transaction_nasabah', 'no_induk')
