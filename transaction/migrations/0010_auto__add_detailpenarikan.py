...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DetailPenarikan'
        db.create_table(u'transaction_detailpenarikan', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('penarikan', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['transaction.Penarikan'])),
            ('pembelian', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['transaction.Pembelian'])),
            ('jumlah', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2)),
        ))
        db.send_create_signal(u'transaction', ['DetailPenarikan'])


    def backwards(self, orm):
        # Deleting model 'DetailPenarikan'
        db.delete_table(u'transaction_detailpenarikan')
